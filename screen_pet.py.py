...
cheek_left = c.create_oval(70, 180, 120 ,230, outline='yellow',fill='yellow', state=HIDDEN)
cheek_right = c.create_oval(280, 180, 330, 230, outline='yellow',fill='yellow', state=HIDDEN)

c.pack()

root.after(1000, blink)
def show_happy(event):
  if (20 <= event.x <= 350) and (20 <= 350):
